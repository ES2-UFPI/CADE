...
let CadastroAnuncioPageModule = class CadastroAnuncioPageModule {
};
...
let CadastroAnuncioPage = class CadastroAnuncioPage {
    constructor(_form, _router, _anuncioService, _alert) {
        this._form = _form;
        ...
        this.categorias = [];
        this.categorias = Object.keys(_Categories__WEBPACK_IMPORTED_MODULE_4__["Categories"]).map(k => _Categories__WEBPACK_IMPORTED_MODULE_4__["Categories"][k]);
...
CadastroAnuncioPage.ctorParameters = () => [
...
//# sourceMappingURL=cadastro-anuncio-cadastro-anuncio-module-es2015.js.map