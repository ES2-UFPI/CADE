...
(function (Categories) {
    ...
    Categories["Roupas"] = "Roupas";
    Categories["Automoveis"] = "Autom\u00F3veis";
    Categories["Eletronicos"] = "Eletr\u00F4nicos";
    Categories["Moveis"] = "M\u00F3veis";
    Categories["Imoveis"] = "Im\u00F3veis";
    Categories["Sapatos"] = "Sapatos";
    Categories["Acessorios"] = "Acess\u00F3rios";
    Categories["Livros"] = "Livros";
    Categories["Supermercado"] = "Supermercado";
    Categories["Comes_E_Bebes"] = "Comes e Bebes";
...
var AnuncioService = /** @class */ (function () {
    function AnuncioService(_db) {
        this._db = _db;
    }
    AnuncioService.prototype.save = function (anuncio) {
    ...
    */
    AnuncioService.prototype.findAll = function () {
        return this._db.collection('anuncios').valueChanges({ idField: 'id' });
    };
    AnuncioService.prototype.findByPerfil = function (perfil) {
        var _this = this;
        var observables = [];
        perfil.categorias.forEach(function (cat) {
            observables.push(_this._db.collection('anuncios', function (ref) { return ref.where('categoria', '==', cat); })
                .valueChanges({ idField: 'id' }));
        });
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["combineLatest"])(observables);
    };
    AnuncioService.ctorParameters = function () { return [
...
var PerfilService = /** @class */ (function () {
    function PerfilService(_storage) {
        this._storage = _storage;
    }
    PerfilService.prototype.save = function (perfil) {
        this._storage.set('perfil', perfil);
    };
    PerfilService.prototype.load = function () {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["from"])(this._storage.get('perfil'));
    };
    PerfilService.ctorParameters = function () { return [
