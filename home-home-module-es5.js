...
var HomePage = /** @class */ (function () {
    function HomePage(_anuncioService, _perfilService) {
    ...
    HomePage.prototype.findAllAnuncios = function () {
        var _this = this;
        this._anuncioService.findAll()
            .subscribe(function (anuncios) {
            _this.anuncios = anuncios;
        });
    };
    HomePage.prototype.findAnunciosByPerfil = function (perfil) {
        var _this = this;
        this._anuncioService.findByPerfil(perfil)
            .subscribe(function (anunciosMatrix) {
            anunciosMatrix.forEach(function (anuncios) {
                anuncios.forEach(function (anuncio) {
                    _this.anuncios.push(anuncio);
                });
            });
        });
    };
