...
var CadastroPerfilPage = /** @class */ (function () {
    function CadastroPerfilPage(_form, _router, _service, _alert) {
        var _this = this;
        this._form = _form;
        ...
        var categorias = Object.keys(_Categories__WEBPACK_IMPORTED_MODULE_6__["Categories"]).map(function (k) { return _Categories__WEBPACK_IMPORTED_MODULE_6__["Categories"][k]; });
        categorias.forEach(function (c) {
            _this.categoriasToggle.push({ val: c, isChecked: false });
        });
    ...
    CadastroPerfilPage.prototype.cadPerfil = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.categoriasToggle.forEach(function (c) {
                            if (c.isChecked == true) {
                                _this.perfil.categorias.push(c.val);
                            }
                        });
    ...
    CadastroPerfilPage.prototype.cancelar = function () {
        this._router.navigate(['/home']);
    };
    CadastroPerfilPage.ctorParameters = function () { return [
...
//# sourceMappingURL=cadastro-perfil-cadastro-perfil-module-es5.js.map